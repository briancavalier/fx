...
import { Fail, catchAll, fail, type RunCatchEffects } from './Fail.js'
...
export type ErrorsOf<E> = UnwrapFail<Extract<RunCatchEffects<E>, Fail<any>>>

const attempt = <const E, const A>(f: Fx<E, A>): Fx<Exclude<RunCatchEffects<E>, Fail<any>>, AttemptResult<ErrorsOf<E>, A>> =>
  f.pipe(
