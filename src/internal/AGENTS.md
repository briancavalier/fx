...
- Keep attached runtime metadata narrowly scoped to yielded effects, thrown errors, and values crossing runtime boundaries.
- Add focused tests when changing async failure handling, scoped cleanup, fork/all/race cancellation, trace propagation, or runtime context metadata attachment.
