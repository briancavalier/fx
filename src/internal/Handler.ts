import { EffectType, isAnyEffect } from "../Effect";
import { Fx } from "../Fx";
...
export class Handler<E, A> implements Fx<E, A>, Pipeable, HandlerContext {
  ...
  constructor(
    ...
    public readonly handlers: ReadonlyMap<
      unknown,
      (e: unknown) => Fx<unknown, unknown>
    >,
    public readonly controls: ReadonlyMap<
      unknown,
      (resume: (a: any) => unknown, e: unknown) => Fx<unknown, unknown>
    >
  ) {}
